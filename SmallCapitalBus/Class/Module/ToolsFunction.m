    ...
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        switch (status) {
            ...
            case AFNetworkReachabilityStatusNotReachable:{
                [ToolsFunction showPromptViewWithString:NSLocalizedString(@"PROMPT_NETWORK_ERROR", nil)
                                             background:nil
                                           timeDuration:5];
                break;
            }
...
{
//    UINavigationController *navigationController = (UINavigationController *)[[AppDelegate appDelegate].mainTabController.viewControllers objectAtIndex:[AppDelegate appDelegate].mainTabController.selectedIndex];
    UINavigationController *navigationController;
    UIViewController *tempViewController = navigationController.topViewController;
...
+ (void)showHttpPromptView:(UIView *)view
{
    ...
    [SVProgressHUD setForegroundColor:[UIColor appSecondColor]];
    if(view != nil)
    {
